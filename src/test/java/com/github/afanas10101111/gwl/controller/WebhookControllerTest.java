...
class WebhookControllerTest {
    ...
    public static final String SIGNATURE_WITH_PREFIX = "sha256=" + SIGNATURE;
    ...
    @BeforeEach
    void setupCryptoServiceMock() {
        when(cryptoServiceMock.hmacSignatureIsValid(anyString(), anyString())).thenReturn(true);
    }
    ...
    @Test
    void invalidSignatureShouldBeHandled() throws Exception {
        when(cryptoServiceMock.hmacSignatureIsValid(anyString(), anyString())).thenReturn(false);
